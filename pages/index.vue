          ...
          <a class="group relative block rounded-xl overflow-hidden" href="#">
            ...
            >
              <img
                ...
                nuxt-link="https://images.unsplash.com/photo-1606868306217-dbf5046868d2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3481&q=80"
        ...
        >
          ...
          <a class="group relative block rounded-xl overflow-hidden" href="#">
            ...
            >
              <img
                class="group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-xl w-full object-cover"
                nuxt-link="https://images.unsplash.com/photo-1605629921711-2f6b00c6bbf4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80"
                alt="Image Description"
              />
            </div>
            <div class="absolute bottom-0 left-0 right-0 p-2 sm:p-4">
        ...
        <div class="col-span-12 md:col-span-4">
          ...
          <a class="group relative block rounded-xl overflow-hidden" href="#">
            ...
            >
              <img
                class="group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-xl w-full object-cover"
                nuxt-link="https://images.unsplash.com/photo-1606836576983-8b458e75221d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"
                alt="Image Description"
              />
            </div>
            <div class="absolute bottom-0 left-0 right-0 p-2 sm:p-4">
        ...
        <div class="col-span-12 sm:col-span-6 md:col-span-4">
          ...
          <a class="group relative block rounded-xl overflow-hidden" href="#">
            ...
            >
              <img
                class="group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-xl w-full object-cover"
                nuxt-link="https://images.unsplash.com/photo-1598929438701-ef29ab0bb61a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1035&q=80"
                alt="Image Description"
              />
            </div>
            <div class="absolute bottom-0 left-0 right-0 p-2 sm:p-4">
        ...
        <div class="col-span-12 sm:col-span-6 md:col-span-4">
          ...
          <a class="group relative block rounded-xl overflow-hidden" href="#">
            ...
            >
              <img
                class="group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-xl w-full object-cover"
                nuxt-link="https://images.unsplash.com/photo-1467043153537-a4fba2cd39ef?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1019&q=80"
                alt="Image Description"
              />
            </div>
            <div class="absolute bottom-0 left-0 right-0 p-2 sm:p-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div class="flex-auto p-4 md:p-6">
              ...
              <p
                class="mt-3 sm:mt-6 text-base text-gray-800 md:text-xl dark:text-white"
              >
                <em>
            ...
            <div class="p-4 rounded-b-xl md:px-6">
              <h3
                class="text-sm font-semibold text-gray-800 sm:text-base dark:text-gray-200"
              >
                Nicole Grazioso
              </h3>
          ...
          >
            ...
            <div class="p-4 rounded-b-xl md:px-6">
              ...
              <p class="text-sm text-gray-500">Product Manager | Capsule</p>
            </div>
          </div>
          <!-- End Card -->
        ...
        >
          <div class="text-center">
            <img
              ...
              nuxt-link="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1548142813-c348350df52b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1624224971170-2f84fed5eb5e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1579017331263-ef82f0bbc748?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1514222709107-a180c68d72b4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1602452920335-6a132309c7c8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1515621061946-eff1c2a352bd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1514846226882-28b324ef7f28?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1610216705422-caa3fcb6d158?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1520409364224-63400afe26e5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1558507652-2d9626c4e67a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
          ...
          <div class="text-center">
            <img
              class="rounded-full w-24 h-24 mx-auto"
              nuxt-link="https://images.unsplash.com/photo-1521151716396-b2da27b1a19f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80"
              alt="Image Description"
            />
            <div class="mt-2 sm:mt-4">
              <h3 class="font-medium text-gray-800 dark:text-gray-200">
